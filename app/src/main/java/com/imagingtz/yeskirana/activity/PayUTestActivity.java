...
public class PayUTestActivity extends AppCompatActivity implements View.OnClickListener {


    int merchantIndex = 0;
    //    int env = PayuConstants.MOBILE_STAGING_ENV;
    // in case of production make sure that merchantIndex is fixed as 0 (0MQaQP) for other key's
    // payu server cant generate hash
    ...
    String mandatoryKeys[] = {PayuConstants.KEY,
    ...
    String mandatoryValues[] = {merchantKey,
            "10.0",
            "myproduct",
            "firstname",
            "me@itsmeonly.com",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_payu_test);
